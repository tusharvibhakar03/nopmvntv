...
public class ElectronicsTest extends BaseTest {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        electronics.sendTextToFirstNameField("Tushar");
        electronics.sendTextToLastNameField("Vibhaker");
        electronics.sendTextToEmailField("tv@gmail.com");
        electronics.sendTextToPasswordField("Indra112");
        electronics.sendTextToConfirmPasswordField("Indra112");
        ...
        electronics.sendTextToAddress("Wealdstone");
        electronics.sendTextToPostelCode("HA3 5RA");
        electronics.sendTextToPhoneNumber("02081630568");
        ...
        electronics.sendTextToCardholderName("T Vibhaker");
        ...
        electronics.sendTextToCardCode("333");
